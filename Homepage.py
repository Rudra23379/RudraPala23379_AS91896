...
class Flagquiz:
    def __init__(self,root):
        ...
        self.title_text = ctk.CTkLabel(self.bg_label, text="Welcome to my flag quiz",
                                  ...
                                  bg_color="#c8e690")
        self.title_text.place(relx=0.49, rely=0.15, anchor="center")
        ...
        help_icon = ctk.CTkButton(self.bg_label, text="?", width=64, height=64, corner_radius=32,
                                  font=("CanvaSans", 32, "bold"), bg_color="#c8e690", hover_color="#ffffff",
                                  fg_color="#2d6349")
        help_icon.place(relx=0.94, rely=0.08, anchor="center")
        #Help button icon
        help_button = ctk.CTkButton(self.bg_label, text="Help", bg_color="transparent", hover_color="#ffffff",
                                    fg_color="#2d6349")
